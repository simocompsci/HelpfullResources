    ...
    <div className="w-full relative">
      ...
      <div className="flex flex-col gap-6 w-full max-w-3xl m-auto">
        ...
        <section className="flex flex-col bg-white border border-gray-200 rounded-3xl p-6">
          ...
          <div className="flex flex-col gap-4">
            <div className="flex flex-col sm:flex-row gap-4 sm:items-center justify-between">
              <div>
                <span className="text-sm font-medium text-gray-900 block">Full Name</span>
                <span className="text-sm text-gray-500">John Doe</span>
              </div>
              <button className="text-sm font-semibold text-[#0a79ff] hover:text-[#096ae0] bg-[#f0efff] hover:bg-[#e4e2fd] px-4 py-2 rounded-xl transition-colors w-fit">
                Edit
              </button>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:items-center justify-between mt-2">
              <div>
                <span className="text-sm font-medium text-gray-900 block">Email Address</span>
        ...
        <section className="flex flex-col bg-white border border-gray-200 rounded-3xl overflow-hidden">
          ...
          <div className="flex items-center justify-between p-6 hover:bg-gray-50 cursor-pointer transition-colors border-b border-gray-100">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="text-base font-semibold text-gray-900">Appearance Details</h3>
                <p className="text-sm text-gray-500">Dark mode turning on soon.</p>
              </div>
            </div>
          ...
          <div className="flex items-center justify-between p-6 hover:bg-gray-50 cursor-pointer transition-colors">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Manage email and alert settings.</p>
              </div>
            </div>
            <ChevronRight size={20} className="text-gray-400" />
          </div>
        ...
        <section className="flex flex-col bg-white border border-red-100 rounded-3xl p-6 mt-4">
          ...
          <p className="text-sm text-gray-500 mb-6 mt-1 ml-[52px]">
            Once you delete your account, there is no going back. Please be certain.
          </p>
          <div className="flex ml-[52px]">
            <button className="bg-red-50 text-red-600 hover:bg-red-100 font-semibold py-2.5 px-6 rounded-xl text-sm transition-all active:scale-95">
              Delete Account
            </button>
          </div>
        </section>
