    ...
    <div className="flex flex-col min-h-screen pb-24 font-body bg-[#f7f5ff]">
      <main className="max-w-4xl mx-auto px-6 mt-12 mb-16 flex-grow">
        ...
        <section className="mb-16 text-center">
          <h2 className="font-headline font-extrabold text-4xl md:text-6xl text-[#242c51] leading-[1.1] mb-6 tracking-tighter">
            ResourceSaver &ndash; Your Digital Resource Manager
          </h2>
          <p className="text-[#515981] text-lg md:text-xl max-w-2xl mx-auto font-body">
        ...
        <section className="mb-12 flex justify-center">
          <div className="inline-flex bg-[#e4e7ff] rounded-xl p-1 gap-1 overflow-x-auto no-scrollbar">
            ...
            <button className="flex-shrink-0 flex items-center gap-2 bg-white text-[#242c51] px-5 py-3 rounded-lg shadow-sm active:scale-95 transition-all">
              <Youtube size={18} />
              <span className="font-headline font-bold text-[11px] tracking-wider uppercase">YOUTUBE</span>
            </button>
            {/* Webpage */}
            <button className="flex-shrink-0 flex items-center gap-2 text-[#515981] px-5 py-3 rounded-lg hover:bg-white/50 active:scale-95 transition-all">
              <Globe size={18} />
              <span className="font-headline font-bold text-[11px] tracking-wider uppercase">WEBPAGE</span>
            </button>
            {/* Documents */}
            <button className="flex-shrink-0 flex items-center gap-2 text-[#515981] px-5 py-3 rounded-lg hover:bg-white/50 active:scale-95 transition-all">
              <FileText size={18} />
              <span className="font-headline font-bold text-[11px] tracking-wider uppercase">DOCUMENTS</span>
            </button>
            {/* Audio */}
            <button className="flex-shrink-0 flex items-center gap-2 text-[#515981] px-5 py-3 rounded-lg hover:bg-white/50 active:scale-95 transition-all">
              <BookAudio size={18} />
              <span className="font-headline font-bold text-[11px] tracking-wider uppercase">AUDIO</span>
            </button>
          </div>
        </section>
        ...
        <section className="bg-white p-8 md:p-12 rounded-3xl border border-[#d6dbff] border-dashed">
          <div className="flex flex-col items-center text-center">
            ...
            <h4 className="font-headline font-bold text-xl text-[#242c51] mb-2">Upload a link (resource) of the application chosen above</h4>
            <p className="text-[#515981] text-sm mb-8 max-w-md">
            ...
            <div className="w-full max-w-xl space-y-4">
              <div className="relative">
                <input
                  ...
                  className="w-full bg-[#f0efff] border-0 focus:ring-2 focus:ring-[#0a79ff] rounded-xl px-6 py-4 text-[#242c51] font-body transition-all outline-none"
                />
              </div>
              <button className="flex items-center justify-center gap-2 w-[220px] mx-auto bg-black text-white py-4 rounded-xl font-headline font-bold text-sm hover:bg-[#242c51] active:scale-95 transition-all duration-200">
