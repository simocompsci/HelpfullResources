  ...
  return (
    <nav className="w-full py-6">
      <div className="flex justify-between items-center mx-4 md:mx-20">
        ...
        {/* Desktop Nav Links */}
        <ul
          className="hidden md:flex fixed top-6 left-1/2 -translate-x-1/2 px-8 py-5 gap-6 text-lg font-medium font-sans rounded-full z-50 bg-white/10 backdrop-blur-xl border border-white/20 text-black"
        >
        ...
        <div className="flex items-center gap-3 font-sans">
          ...
          >
            {menuOpen ? (
              <X size={28} className="bg-gray-300 rounded-lg" />
            ) : (
              <Menu size={28} />
            )}
          </button>
