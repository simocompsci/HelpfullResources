        ...
        <div className="flex flex-col items-center text-center">
          ...
          <div className="w-full max-w-xl space-y-4">
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 w-full sm:w-[220px] mx-auto bg-black text-white py-3 sm:py-4 rounded-xl font-mono font-semibold text-sm hover:bg-gray-800 active:scale-95 transition-all duration-200"
            >
